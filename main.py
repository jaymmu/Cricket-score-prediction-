...
# SET PAGE WIDE
st.set_page_config(page_title='Cricket_Score_Predictor', layout="centered")
...
st.markdown("<h1 style='text-align: center; color: white;'> Criket Score Predictor</h1>", unsafe_allow_html=True)
...
st.markdown(
    f"""
         <style>
         .stApp {{
             background-image: ("https://in.images.search.yahoo.com/search/images;_ylt=AwrKFiT_D5xm5TYitii7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3BpdnM-?p=mmdu&fr2=piv-web&type=E210IN105G0&fr=mcafee#id=21&iurl=https%3A%2F%2Fwww.targetadmission.com%2Fimg%2Fcolleges%2Fnewc%2F49311-527162.jpg&action=click");
...
with st.expander("Description"):
    st.info("""A Simple ML Model to predict stre Scores between teams in an ongoing match. To make sure the model results accurate score and some reliability the minimum no. of current overs considered is greater than 5 overs.
